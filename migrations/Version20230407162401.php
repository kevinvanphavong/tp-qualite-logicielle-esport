 ...
 */
final class Version20230407162401 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ematch (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, INDEX IDX_55820D52E48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE score (id INT AUTO_INCREMENT NOT NULL, player_id INT DEFAULT NULL, ematch_id INT NOT NULL, total_points INT NOT NULL, number_kills INT NOT NULL, number_deaths INT NOT NULL, number_assists INT NOT NULL, INDEX IDX_3299375199E6F5DF (player_id), INDEX IDX_32993751BF61A3FA (ematch_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE team (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, score_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_C4E0A61FE48FD905 (game_id), UNIQUE INDEX UNIQ_C4E0A61F12EB0A51 (score_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
